...
def generate_launch_description():
    ...
    # lets copy above format for the PlotJuggler config.
    PlotJuggler_config = PathJoinSubstitution(
        [FindPackageShare("ex2"), "config", "Config_PlotJuggler.xml"]
    )
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            "end_effector:=ft_sensor", # End effector set to be forcetorque sensor
            " ",
            "camera:=true", # Added camera condition to true
            " ",
            "sim_ignition:=true",
            " ",
    ...
    ros_gz_bridge = Node(
        ...
        arguments=[
            ...
            # so looking from ros_gz_bridge documentation lets bridge the forcetorque
            "/ft_sensor/data@geometry_msgs/msg/WrenchStamped@ignition.msgs.Wrench",
        ],
    )
